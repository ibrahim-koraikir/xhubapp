                ...
                try {
                    ...
                    if (fulguris.utils.FileUtils.fileExists(application, session)) {
                        ...
                        if (fulguris.utils.FileUtils.fileExists(application, backup)) {
                            if (!fulguris.utils.FileUtils.deleteBundleInStorageVerified(application, backup)) {
                        ...
                        if (!fulguris.utils.FileUtils.renameBundleInStorage(application, session, backup)) {
                            ...
                            fulguris.utils.FileUtils.deleteBundleInStorageVerified(application, temp)
                            return@withLock
                        }
                    ...
                    if (!fulguris.utils.FileUtils.renameBundleInStorage(application, temp, session)) {
                        ...
                        if (fulguris.utils.FileUtils.fileExists(application, backup)) {
                            ...
                            fulguris.utils.FileUtils.renameBundleInStorage(application, backup, session)
                        }
                        return@withLock
                    }
