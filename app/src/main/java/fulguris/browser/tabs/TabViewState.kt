 ...
 * @param previewVersion A lightweight integer token incremented every time the preview bitmap changes.
 *                       Used for DiffUtil comparisons so the adapter knows to rebind, without holding
 *                       a Bitmap reference outside of [TabThumbnailCache].
 */
