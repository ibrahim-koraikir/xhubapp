...
import fulguris.fragment.SearchOverlayFragment
...
//        }
    ...
    private fun initialize(savedInstanceState: Bundle?) {
        ...
        iBindingToolbarContent.buttonBookmarks?.setOnClickListener { 
            val bottomSheet = fulguris.fragment.HistoryBookmarksBottomSheet()
        ...
        iBindingToolbarContent.buttonMore?.setOnClickListener {
            fulguris.fragment.SettingsMenuBottomSheet().show(supportFragmentManager, "SettingsMenuBottomSheet")
        }
        ...
        iBindingToolbarContent.toolbarAudioButton?.setOnClickListener {
            fulguris.fragment.AskOverlayFragment().show(supportFragmentManager, "AskOverlayFragment")
        }
...
//            }
    ...
    */
    ...
    private fun buildDynamicShortcuts() {
        ...
        // Configure greeting and title gradient
        ...
        homeGreeting?.text = "$greetingText"
