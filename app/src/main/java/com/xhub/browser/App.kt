...
import com.xhub.browser.activity.IncognitoActivity
...
import com.xhub.browser.settings.preferences.DeveloperPreferences
import com.xhub.browser.settings.preferences.LandscapePreferences
import com.xhub.browser.settings.preferences.PortraitPreferences
import com.xhub.browser.settings.preferences.UserPreferences
import com.xhub.browser.utils.installMultiDex
...
import com.xhub.browser.settings.Config
import com.xhub.browser.settings.preferences.ConfigurationPreferences
...
class App : Application(), SharedPreferences.OnSharedPreferenceChangeListener,
    ...
    override fun onActivityDestroyed(activity: Activity) {
        ...
        com.xhub.browser.utils.MemoryLeakUtils.clearNextServedView(activity, this@App)
    }
    ...
    override fun onCreate() {
        ...
        Thread.setDefaultUncaughtExceptionHandler { thread, ex ->
            if (userPreferences.crashLogs) {
                com.xhub.browser.utils.FileUtils.writeCrashToStorage(ex)
            }
        ...
        RxJavaPlugins.setErrorHandler { throwable: Throwable? ->
            if (userPreferences.crashLogs && throwable != null) {
                com.xhub.browser.utils.FileUtils.writeCrashToStorage(throwable)
                throw throwable
            }
        }

        // Apply locale
        val requestLocale = com.xhub.browser.locale.LocaleUtils.requestedLocale(userPreferences.locale)
        com.xhub.browser.locale.LocaleUtils.updateLocale(this, requestLocale)
        ...
        com.xhub.browser.utils.ActivityAliasManager.updateEnabledActivity(this, userPreferences.incomingViewAction)
    ...
    companion object {
         ...
         */
        fun setLocale() {
            val requestLocale = com.xhub.browser.locale.LocaleUtils.requestedLocale(app.userPreferences.locale)
            com.xhub.browser.locale.LocaleUtils.updateLocale(app, requestLocale)
        }
