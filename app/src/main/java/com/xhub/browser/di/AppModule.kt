...
import com.xhub.browser.device.BuildInfo
import com.xhub.browser.device.BuildType
import com.xhub.browser.extensions.landscapeSharedPreferencesName
import com.xhub.browser.extensions.portraitSharedPreferencesName
import com.xhub.browser.html.ListPageReader
import com.xhub.browser.html.bookmark.BookmarkPageReader
import com.xhub.browser.html.homepage.HomePageReader
...
import com.xhub.browser.html.incognito.IncognitoPageReader
...
class AppModule {
    ...
    fun providesSuggestionsHttpClient(application: Application): Single<OkHttpClient> = Single.fromCallable {
        ...
        return@fromCallable OkHttpClient.Builder()
            .cache(Cache(suggestionsCache, com.xhub.browser.utils.FileUtils.megabytesToBytes(1)))
