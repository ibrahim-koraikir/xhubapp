 ...
 */
package com.xhub.browser.database.history

import com.xhub.browser.database.HistoryEntry
import com.xhub.browser.database.databaseDelegate
import com.xhub.browser.extensions.firstOrNullMap
import com.xhub.browser.extensions.useMap
...
class HistoryDatabase @Inject constructor(
    ...
    private fun HistoryEntry.toContentValues() = ContentValues().apply {
        put(com.xhub.browser.database.history.HistoryDatabase.KEY_URL, url)
        put(com.xhub.browser.database.history.HistoryDatabase.KEY_TITLE, title)
        put(com.xhub.browser.database.history.HistoryDatabase.KEY_TIME_VISITED, lastTimeVisited)
    }
