package com.xhub.browser.database.adblock

import com.xhub.browser.adblock.UnifiedFilterResponse
import com.xhub.browser.database.adblock.UserRulesRepository.Companion.RESPONSE_BLOCK
import com.xhub.browser.database.adblock.UserRulesRepository.Companion.RESPONSE_EXCLUSION
import com.xhub.browser.database.adblock.UserRulesRepository.Companion.RESPONSE_NOOP
import com.xhub.browser.database.databaseDelegate
...
class UserRulesDatabase @Inject constructor(
    ...
    private fun UnifiedFilterResponse.toContentValues() = ContentValues(10).apply {
        put(com.xhub.browser.database.adblock.UserRulesDatabase.KEY_RESPONSE, response.toInt())
        put(com.xhub.browser.database.adblock.UserRulesDatabase.KEY_PATTERN, filter.pattern)
        put(com.xhub.browser.database.adblock.UserRulesDatabase.KEY_FILTER_TYPE, filter.filterType)
        put(com.xhub.browser.database.adblock.UserRulesDatabase.KEY_CONTENT_TYPE, filter.contentType)
        put(com.xhub.browser.database.adblock.UserRulesDatabase.KEY_THIRD_PARTY, filter.thirdParty)
        put(com.xhub.browser.database.adblock.UserRulesDatabase.KEY_DOMAIN_MAP, filter.domains?.toDBString() ?: "")
    }
