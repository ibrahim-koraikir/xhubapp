...
object ActivityAliasManager {
    ...
    private const val ALIAS_BROWSER_ACTIVITY = "com.xhub.browser.alias.default.BrowserActivity"
    private const val ALIAS_INCOGNITO_ACTIVITY = "com.xhub.browser.alias.default.IncognitoActivity"
    private const val SELECT_BROWSER_ACTIVITY = "com.xhub.browser.activity.SelectBrowserActivity"
