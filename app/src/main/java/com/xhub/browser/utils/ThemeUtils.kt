...
object ThemeUtils {
    ...
    private fun getVectorDrawable(context: Context, drawableId: Int): Drawable {
        ...
        com.xhub.browser.utils.Preconditions.checkNonNull(drawable)
    ...
    /**
     * Gets the search bar background color.
     * For dark backgrounds we use a consistent dark address bar color (Perplexity style).
     */
    @JvmStatic
    ...
    /**
     * Gets the focused search bar background color.
     * For dark backgrounds we use a consistent dark address bar color (Perplexity style).
     */
    @JvmStatic
