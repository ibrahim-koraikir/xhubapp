...
fun fixScrollBug(aList : RecyclerView): Boolean {
    val lm = aList.layoutManager as? LinearLayoutManager ?: return false
    
    // GridLayoutManager does not support stackFromEnd, it throws an UnsupportedOperationException
