...
import com.xhub.browser.browser.MenuItems
import com.xhub.browser.browser.MenuItemId
import com.xhub.browser.browser.MenuConfiguration
import com.xhub.browser.browser.MenuType
import com.xhub.browser.browser.MenuItemConfig
...
class MenusSettingsFragment : AbstractSettingsFragment() {
    ...
    private fun populateMenuItems() {
        ...
        fun createPref(menuItem: com.xhub.browser.browser.MenuItem): x.Preference {
