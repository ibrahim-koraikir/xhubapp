    ...
    override fun onCreatePreferences(savedInstanceState: Bundle?, rootKey: String?) {
        ...
        findPreference<ListPreference>(getString(R.string.pref_key_locale))?.apply {
            onPreferenceChangeListener = Preference.OnPreferenceChangeListener { _, aNewLocale: Any ->
                ...
                val newLocale = com.xhub.browser.locale.LocaleUtils.requestedLocale(newLocaleId)
                // Update app configuration with selected locale
                com.xhub.browser.locale.LocaleUtils.updateLocale(activity, newLocale)
                // Reload our activity
    ...
    private fun populateConfigurations() {
        ...
        if (directory.exists() && directory.isDirectory) {
            ...
            list?.forEach {
                ...
                pref.fragment = "com.xhub.browser.settings.fragment.ConfigurationCustomSettingsFragment"
        ...
        MaterialAlertDialogBuilder(activity as Activity).apply {
            ...
            val customView = (layoutInflater.inflate(R.layout.dialog_seek_bar, null) as LinearLayout).apply {
                val text = TextView(activity).apply {
                    ...
                    height = com.xhub.browser.utils.Utils.dpToPx(100f)
                }
                addView(text, 0)
