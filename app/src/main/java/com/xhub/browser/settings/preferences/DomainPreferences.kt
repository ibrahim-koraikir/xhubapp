...
import com.xhub.browser.extensions.reverseDomainName
import com.xhub.browser.settings.NoYesAsk
import com.xhub.browser.enums.IncomingUrlAction
...
class DomainPreferences constructor(
    ...
    fun getOverridesSummary(context: Context, callback: (String) -> Unit) {
        ...
        if (!isDefault && exists(domain)) {
            ...
            if (allowMixedContentOverride) {
                overrides.add(context.getString(R.string.pref_title_allow_mixed_content))
            }
     ...
     * Uses WebView's GeolocationPermissions API.
     * This domain will be able to access location without calling [com.xhub.browser.view.WebPageChromeClient.onGeolocationPermissionsShowPrompt].
     */
     ...
     * Uses WebView's GeolocationPermissions API.
     * Next time this domain tries to access location [com.xhub.browser.view.WebPageChromeClient.onGeolocationPermissionsShowPrompt] will be called.
     */
