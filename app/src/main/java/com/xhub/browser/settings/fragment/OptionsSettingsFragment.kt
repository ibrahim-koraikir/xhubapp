...
import com.xhub.browser.extensions.isLandscape
import com.xhub.browser.extensions.isPortrait
...
import com.xhub.browser.extensions.configId
import com.xhub.browser.settings.Config
import com.xhub.browser.settings.preferences.ConfigurationCustomPreferences
...
class OptionsSettingsFragment : AbstractSettingsFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val isIncognito = requireActivity() is com.xhub.browser.activity.IncognitoActivity
        ...
        find<Preference>(R.string.pref_key_full_menu)?.setOnPreferenceClickListener {
            ...
            (requireActivity() as? com.xhub.browser.activity.WebBrowserActivity)?.apply {
                dismissBottomSheet()
                showMenuFull()
            }
            true
