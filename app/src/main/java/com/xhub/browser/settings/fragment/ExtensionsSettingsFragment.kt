...
class ExtensionsSettingsFragment : AbstractSettingsFragment() {
        ...
        if (scripts.isEmpty()) {
            ...
            scripts.forEachIndexed { index, script ->
                val scriptPref = DetailSwitchPreference(
                    ...
                    fragment = "com.xhub.browser.settings.fragment.ExtensionSettingsFragment"
    ...
    private fun buildScriptSummary(script: com.xhub.browser.userscript.UserScript): String {
