...
class ExtensionSettingsFragment : AbstractSettingsFragment() {
    ...
    private fun openCodeEditor(scriptId: String) {
        val intent = com.xhub.browser.activity.CodeEditorActivity.createIntent(requireContext(), scriptId)
        startActivity(intent)
    }

    private fun populateScriptInfo(script: com.xhub.browser.userscript.UserScript) {
        // Name with icon
    ...
    private fun confirmDeleteScript(script: com.xhub.browser.userscript.UserScript) {
