...
import com.xhub.browser.extensions.findViewByType
import com.xhub.browser.extensions.onceOnLayoutChange
...
import com.xhub.browser.utils.Utils.startActivityForFolder
...
class DebugSettingsFragment : AbstractSettingsFragment() {
    ...
    private fun openCrashLogsFolder() {
        startActivityForFolder(context, com.xhub.browser.utils.FileUtils.getFolderCrashLogs().absolutePath)
    }
