...
import com.xhub.browser.constant.TEXT_ENCODINGS
...
import com.xhub.browser.search.Suggestions
...
import com.xhub.browser.settings.preferences.USER_AGENTS_ORDERED
import com.xhub.browser.settings.preferences.USER_AGENT_CUSTOM
...
import com.xhub.browser.extensions.find
...
class GeneralSettingsFragment : AbstractSettingsFragment() {
    ...
    @Inject lateinit var networkEngineManager: com.xhub.browser.network.NetworkEngineManager
    ...
    override fun onCreatePreferences(savedInstanceState: Bundle?, rootKey: String?) {
        ...
        findPreference<x.EditTextPreference>(getString(R.string.pref_key_network_cache_size))?.apply {
            ...
            setOnPreferenceChangeListener { _, _ ->
                ...
                (networkEngineManager.getCurrentEngine() as? com.xhub.browser.network.NetworkEngineOkHttp)?.recreateClient()
    ...
    private fun showDownloadLocationDialog(summaryUpdater: SummaryUpdater) : Boolean {
        activity?.let {
            ...
            setSingleChoiceItems(R.array.download_folder, n) { _, which ->
                when (which) {
                    0 -> {
                        userPreferences.downloadDirectory = com.xhub.browser.utils.FileUtils.DEFAULT_DOWNLOAD_PATH
                        summaryUpdater.updateSummary(com.xhub.browser.utils.FileUtils.DEFAULT_DOWNLOAD_PATH)
                    }
                    1 -> {
        ...
        activity?.let { activity ->
            ...
            BrowserDialog.showCustomDialog(activity) {
                ...
                setPositiveButton(R.string.action_ok) { _, _ ->
                    ...
                    text = com.xhub.browser.utils.FileUtils.addNecessarySlashes(text)
    ...
    private class DownloadLocationTextWatcher(
        ...
        override fun afterTextChanged(s: Editable) {
            if (!com.xhub.browser.utils.FileUtils.isWriteAccessAvailable(s.toString())) {
