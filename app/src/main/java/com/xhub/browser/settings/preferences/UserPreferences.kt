...
import com.xhub.browser.constant.DEFAULT_ENCODING
import com.xhub.browser.constant.Uris
import com.xhub.browser.device.ScreenSize
import com.xhub.browser.di.UserPrefs
...
import com.xhub.browser.browser.SuggestionNumChoice
import com.xhub.browser.enums.LogLevel
import com.xhub.browser.enums.HeaderInfo
import com.xhub.browser.enums.IncomingViewAction
import com.xhub.browser.enums.LayerType
import com.xhub.browser.settings.preferences.delegates.booleanPreference
import com.xhub.browser.settings.preferences.delegates.enumPreference
import com.xhub.browser.settings.preferences.delegates.floatResPreference
import com.xhub.browser.settings.preferences.delegates.intPreference
import com.xhub.browser.settings.preferences.delegates.stringPreference
...
class UserPreferences @Inject constructor(
    ...
    /**
     * True if video detection via JavaScript interface should be enabled, false otherwise.
     * When enabled, the VideoSniffer JavaScript interface is exposed to web pages to detect
    ...
    var onTabChangeShowAnimation by preferences.booleanPreference(R.string.pref_key_on_tab_change_show_animation, true)
    ...
    var onTabBackShowAnimation by preferences.booleanPreference(R.string.pref_key_on_tab_back_show_animation, true)
