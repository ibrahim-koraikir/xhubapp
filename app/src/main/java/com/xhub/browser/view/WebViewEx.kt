...
class WebViewEx : WebView {
    ...
    fun print() : PrintJob {
        ...
        // Use null-safe title handling with fallback to URL or "Untitled"
        val documentTitle = title?.takeIf { it.isNotBlank() } 
            ?: url?.takeIf { it.isNotBlank() } 
            ?: context.getString(com.xhub.browser.R.string.untitled)
        
        val printAdapter: PrintDocumentAdapter = createPrintDocumentAdapter(documentTitle)
