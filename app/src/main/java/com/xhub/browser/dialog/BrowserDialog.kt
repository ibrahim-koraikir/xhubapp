...
import com.xhub.browser.list.RecyclerViewDialogItemAdapter
import com.xhub.browser.list.RecyclerViewStringAdapter
...
import com.xhub.browser.extensions.doOnShow
...
object BrowserDialog {
    ...
    fun show(aContext: Context, @androidx.annotation.DrawableRes aIconRes: Int, aTitle: String?, aHideSingleTab: Boolean, vararg aTabs: DialogTab) {
        ...
        // Set transparent background and bottom gravity
