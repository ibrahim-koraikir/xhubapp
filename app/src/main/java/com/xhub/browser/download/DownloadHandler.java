...
import static com.xhub.browser.utils.UrlUtils.guessFileName;
import com.xhub.browser.extensions.AlertDialogExtensionsKt;
...
public class DownloadHandler {
    ...
    public void onDownloadStart(@NonNull Activity context, @NonNull UserPreferences manager, @NonNull String url, String userAgent,
                                @Nullable String contentDisposition, String mimeType, @NonNull String contentSize, @Nullable String referer) {
        ...
        Timber.d("DOWNLOAD: Referer: %s", referer);
        ...
        onDownloadStartNoStream(context, manager, url, userAgent, contentDisposition, mimeType, contentSize, referer);
    }
    ...
    public void onDownloadStartWithFilename(@NonNull Activity context, @NonNull UserPreferences manager,
        ...
        onDownloadStartNoStreamWithFilename(context, manager, url, userAgent, contentDisposition, mimeType, contentSize, customFilename, referer);
    }
    ...
    private void showDownloadPendingSnackbar(@NonNull WebBrowserActivity context, @NonNull String message) {
        com.xhub.browser.extensions.ActivityExtensions.makeSnackbar(
                context,
                message,
                4000, // KDuration
                com.xhub.browser.di.Injector.getConfigPrefs(context).getToolbarsBottom() ? android.view.Gravity.TOP : android.view.Gravity.BOTTOM
