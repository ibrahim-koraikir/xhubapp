...
import com.xhub.browser.locale.LocaleUtils
...
abstract class LocaleAwareActivity :
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mLastLocale = com.xhub.browser.locale.LocaleUtils.requestedLocale(userPreferences.locale)
        com.xhub.browser.locale.LocaleUtils.updateLocale(this, mLastLocale)
    ...
    override fun onConfigurationChanged(newConfig: Configuration) {
        val requestedLocale = com.xhub.browser.locale.LocaleUtils.requestedLocale(userPreferences.locale)
