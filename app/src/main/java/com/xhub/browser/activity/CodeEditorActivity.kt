...
import com.xhub.browser.databinding.ActivityCodeEditorBinding
...
class CodeEditorActivity : ThemedActivity() {
    ...
    private fun isDarkMode(): Boolean {
        ...
        return when (userPreferences.useTheme) {
            com.xhub.browser.AppTheme.DARK, com.xhub.browser.AppTheme.BLACK -> true
            com.xhub.browser.AppTheme.LIGHT, com.xhub.browser.AppTheme.WHITE -> false
            com.xhub.browser.AppTheme.DEFAULT -> {
