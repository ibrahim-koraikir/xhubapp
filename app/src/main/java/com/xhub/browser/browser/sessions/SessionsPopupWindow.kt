...
package com.xhub.browser.browser.sessions
...
import com.xhub.browser.databinding.SessionListBinding
...
import com.xhub.browser.utils.FileNameInputFilter
    ...
    fun show(aAnchor: View, aEdit: Boolean = false, aShowCurrent: Boolean = true) {
        ...
        if (configPrefs.verticalTabBar && !configPrefs.tabBarInDrawer) {
            ...
            showAtLocation(aAnchor, gravity,
                    ...
                    com.xhub.browser.utils.Utils.dpToPx(10F),
                    // Below our anchor
                    yOffset)
        }
