...
import com.xhub.browser.databinding.MenuCustomBinding
...
import com.xhub.browser.utils.isAppScheme
...
class MenuPopupWindow : PopupWindow {
    ...
    fun show(aAnchor: View) {
        ...
        showAtLocation(
            aAnchor,
            gravity,
            com.xhub.browser.utils.Utils.dpToPx(10F), // Offset from the right screen edge
            yOffset
        )
