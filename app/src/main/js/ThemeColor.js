 ...
 *
 * Usage:
 * This script is used by XHub's Color Mode feature to dynamically adapt the browser UI
        ...
        mutations.forEach(function(mutation) {
            if (mutation.type === 'attributes' && mutation.attributeName === 'content') {
                ...
                if (tagName === 'theme-color') {
                    console.debug('xhub: meta-theme-color: ' + newValue);
                } else if (tagName === 'color-scheme') {
                    console.debug('xhub: meta-color-scheme: ' + newValue);
                }
            }
        });
    });
